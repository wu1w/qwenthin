...
const BASH: &str = r#"{"type":"function","function":{"name":"bash","description":"Run Bash (PowerShell fallback on Windows).","parameters":{"type":"object","properties":{"command":{"type":"string"}},"required":["command"]}}}"#;
